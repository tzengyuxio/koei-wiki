...
| :--- | :---: | :--- | :---: | :--- |
| `F0023.png` | 23 | 格魯希 | 52 | 格魯希(法蘭西) × 2 — 需以其他方式區分 |
| `F0025.png` | 25 | 莫羅 | 41 | 莫羅(法蘭西) × 2 — 需以其他方式區分 |
| `F0155.png` | 155 | 貝利加德 | 175 | 貝利加德(奧地利) + 貝利加德(巴伐利亞) |
| `F0157.png` | 157 | 費迪南 | 202 | 費迪南(奧地利) + 費迪南(西班牙) |
| `F0161.png` | 161 | 路易斯 | 3 | 路易斯(法蘭西) + 路易斯(奧地利) |
| `F0249.png` | 249 | 詹森 | 171 | 詹森(荷蘭) + 詹森(丹麥) |

### 6c. 超出角色範圍的額外圖檔 (5 張)

Face index 255–259，不對應任何遊戲角色：`F0255.png`、`F0256.png`、`F0257.png`、`F0258.png`、`F0259.png`。
